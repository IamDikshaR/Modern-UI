  ...
  return (
    <div className=" fixed top-0 z-50 bg-n-8/90 backdrop-blur-sm border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm">
      <div className="flex item-center px-5 lg:px-7 5 xl:px-10 max-lg:py-4 ">
        <a className="block w-[12 rem] xl:mr-8 mt-5" href="#hero">
        ...
        <a
          href="#signup"
          className="mt-8 button hidden mr-8 text-n-1/50 transition-colors hover:text-n-1 lg:block"
        >
          New account
        </a>
        <Button className=" mt-5 hidden lg:flex" href="#login">
          Sign in
        </Button>
      </div>
    </div>
